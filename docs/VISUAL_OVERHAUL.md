...
| P0 | Linux CPU4x 최대부하 18.3fps | 60적·30구조물 이상에서 실루엣·종류·방향·상태를 보존하는 고밀도 LOD + 내부 DPR 1.25 상한 |
...
3. 모바일 DPR 1.5, 적 22/45 LOD, 적 60, 파티클 260 상한을 적용합니다. 적 45 초과·구조물 30개 이상에서는 미세 부품만 생략하는 고밀도 LOD와 내부 DPR 1.25 상한을 적용합니다.
